  ...
  return new Promise<NextResponse>((resolve) => {
    ...
    form.parse(nodeReq, async (err: any, fields: Fields, files: Files) => {
      ...
      try {
        ...
        let publicUrl = `https://petrosphere.com.ph/uploads/petrobook/customer_attachments/${newFileName}`;
        ...
        try {
          ...
          publicUrl = `https://petrosphere.com.ph/uploads/petrobook/customer_attachments_${newFileName}`;
          await client.uploadFrom(attachmentFile.filepath, uploadPath);
